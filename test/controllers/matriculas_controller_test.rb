...
class MatriculasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create matricula" do
    assert_difference('Matricula.count') do
      post matriculas_url, params: { matricula: { ano: @matricula.ano, curso: @matricula.curso, nome: @matricula.nome, numero: @matricula.numero } }
    end
  ...
  test "should update matricula" do
    patch matricula_url(@matricula), params: { matricula: { ano: @matricula.ano, curso: @matricula.curso, nome: @matricula.nome, numero: @matricula.numero } }
